...
### Running atsirk Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start atsirk locally by running:
...
Then you can interact with atsirk by typing `atsirk help`.

    atsirk> atsirk help
    atsirk animate me <query> - The same thing as `image me`, except adds [snip]
    atsirk help - Displays all of the help commands that atsirk knows about.
    ...
